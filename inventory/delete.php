<!DOCTYPE html>
<html>
<head><title>Delete | Inventory</title>
          ...
          <button type="button" class="hamburger is-closed animated fadeInLeft" data-toggle="offcanvas">
            ...
            <div class="container">
            	 <div class="row">
                    ...
                    <div class="col-lg-12">
                   	<center><h2 style="color:#000;font-family: 'Raleway';font-size: 30px;text-shadow: 1px 1px 2px #000000;">Delete Data</h2></center>
...
if ($result->num_rows > 0) {
    ...
    while($row = $result->fetch_assoc()) {
		...
		echo "<td style='text-align:center; vertical-align:middle;'><a href='#' class='selectselect' data-id='".$row['id']."'   data-toggle='modal' data-target='#modal_update'><button type='button' class='btn btn-danger btn-xs'>Delete</button> </a></td>";
		echo "</tr>";
	    ...
	    <!-- Modal content-->
	        <div class="modal-content">
			    ...
			    <br>
			    		...
			    		<div id="data1"></div>
			    		<button id="insert" class="btn btn-success" style='width: 100px;'>Yes</button>
